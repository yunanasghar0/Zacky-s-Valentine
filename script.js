const CONFIG = {
    mainQuestion: "Will you be my Valentine Zackyy?",
    subQuestion: "Please say yes (maksa bgt akumah) ",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Eits, ga bisa😝", "Hehe, coba lagi 😜", "Yaudah deh, aku anggap YES ya! 💕"],
    confirmTitle: "YEAAAY! Zackyy Beneran Mau 💗",
    ...
    finalMessage: `Makasih ya sudah hadir dan bikin hariku selalu terasa cukup. Kamu adalah alasan kenapa senyum itu mudah muncul. Semoga hari harimu selalu penuh kehangatan dan kebahagiaan. Aku selalu ada untukmu. Happy Valentine Zackyy💕`,
